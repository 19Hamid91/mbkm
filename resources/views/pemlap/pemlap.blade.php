...
@section('js')
    ...
    <script>
        $("tr td #btn_nilai_pemlap").on("click",function(){
            var id=$(this).data("id")
            var url=$(this).data("url")
            var nama=$(this).data("nama")
            var type=$(this).data("type")
            type = type == "pemlap" ? "Pembimbing Lapangan" : type
